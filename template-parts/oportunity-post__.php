...
<div class="oplist__item" data-id="<?=$item['name']?>">
    <figure class="fig-contain oplist__image">
        <a href="<?=home_url('/oportunidades/empresa/' . $item['company'] . '/'.$item['name'].'/')?>"<?=$blank?' target="_blank"':''?>>
            <img src="<?=$item['company_image']?>" alt="" />
        </a>
    </figure>
    <div class="oplist__main">
        <div class="oplist__main--company"><a href="<?=home_url('/oportunidades/empresa/' . $item['company'].'/')?>" target="_blank"><?=@$company['company']?></a></div>
        <h3 class="oplist__main--job"><a href="<?=home_url('/oportunidades/empresa/' . $item['company'] . '/'.$item['name'].'/')?>"<?=$blank?' target="_blank"':''?>><?=$item['job']?></a></h3>
